...
describe('actions/IOU', () => {
    ...
    describe('deleteMoneyRequest', () => {
        ...
        it('should delete the transaction thread regardless of whether there are visible comments in the thread.', async () => {
            ...
            const transactionThread = getReportOrDraftReport(thread.reportID);
            expect(transactionThread).toBeFalsy();
        });
    ...
    describe('mergeDuplicates', () => {
        ...
        it('should delete the thread reports of the duplicated transactions', async () => {
            // Given: Set up test data with main transaction and duplicates
