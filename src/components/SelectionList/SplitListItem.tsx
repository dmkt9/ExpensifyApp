...
function SplitListItem<TItem extends ListItem>({
    ...
    const amountInputRef = useRef<BaseTextInputRef>(null);
    ...
    const onAmountInputFocus = useCallback(
        () => {
            splitItem.onAmountInputFocus?.(amountInputRef, containerRef);
        },
        // eslint-disable-next-line react-compiler/react-compiler
        // eslint-disable-next-line react-hooks/exhaustive-deps
        [splitItem.onAmountInputFocus],
    );
