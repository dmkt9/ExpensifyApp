...
function MoneyRequestConfirmationListFooter({
    ...
    const selectedReportIDFromParticipants = selectedParticipants?.at(0)?.reportID;
    ...
    const iouReportID = allReports?.[`${ONYXKEYS.COLLECTION.REPORT}${selectedReportIDFromParticipants ?? reportID}`]?.iouReportID;
